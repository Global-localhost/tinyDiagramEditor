...
if (userLanguage.substring(0,2)=="es")
    ...
    Text.ALIGNMENTS = [{Value: Text.ALIGN_LEFT,  Text:'Izquierda'},
                       {Value: Text.ALIGN_CENTER,Text:'Centro'},
                       {Value: Text.ALIGN_RIGHT, Text:'Derecha'}];
    }
    else
    {
    /**An {Array} with horizontal alignments*/
    Text.ALIGNMENTS = [{Value: Text.ALIGN_LEFT,  Text:'Left'},
                       {Value: Text.ALIGN_CENTER,Text:'Center'},
                       {Value: Text.ALIGN_RIGHT, Text:'Right'}];
    }
